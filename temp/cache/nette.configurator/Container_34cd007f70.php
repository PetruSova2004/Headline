<?php
// source: /home/petru/www/projects/nette-headline-project/config/common.neon
// source: /home/petru/www/projects/nette-headline-project/config/services.neon
// source: array
...
class Container_34cd007f70 extends Nette\DI\Container
{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/home/petru/www/projects/nette-headline-project/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\FileStorage('/home/petru/www/projects/nette-headline-project/temp/cache');
	}
	...
	public function createServiceDatabase__default__connection(): Nette\Database\Connection
	{
		$service = new Nette\Database\Connection(
			'mysql:unix_socket=/opt/lampp/var/mysql/mysql.sock;dbname=headline;charset=utf8',
			/*sensitive{*/'root'/*}*/,
			/*sensitive{*/''/*}*/,
			['autocommit' => true],
		);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_34cd007f70 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/home/petru/www/projects/nette-headline-project/temp/cache/latte');
